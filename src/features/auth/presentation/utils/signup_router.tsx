...
const CreateUserPage = lazy(() =>
  import("../signup/pages/create_user_page").then(
    (m) => ({
...
const VerificationPage = lazy(() =>
  import("../signup/pages/verification_page").then(
    (m) => ({
...
const WorkSpacePage = lazy(() =>
  import("../signup/pages/workspace_page").then(
    (m) => ({
...
const ConnectGitHubPage = lazy(() =>
  import("../signup/pages/connect_github_page").then(
    (m) => ({
...
const SuccessRegisterPage = lazy(() =>
  import("../signup/pages/success_register_page").then(
    (m) => ({
...
export const SignupRouter=()=>{
    ...
    const Component=stepComponents[
        step as keyof typeof stepComponents
    ]
